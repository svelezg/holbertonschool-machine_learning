...
if __name__ == "__main__":
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(epochs):
            cost, accuracy = sess.run((loss, acc),
                                      feed_dict={x: X_train_c, y: Y_train})
            cost_valid, accuracy_valid = \
                sess.run((loss, acc),
                         feed_dict={x: X_valid_c, y: Y_valid})
            print(
                "After {} epochs: {} cost, {} accuracy,"
                "{} validation cost,"
                "{} validation accuracy".format(epoch, cost,
                                                accuracy,
                                                cost_valid,
                                                accuracy_valid))
        ...
        cost_valid, accuracy_valid = \
            sess.run((loss, acc),
                     feed_dict={x: X_valid_c, y: Y_valid})
        print("After {} epochs: {} cost, {} accuracy,"
              "{} validation cost,"
              "{} validation accuracy".format(epochs, cost,
                                              accuracy,
                                              cost_valid,
                                              accuracy_valid))
