...
def BIC(X, kmin=1, kmax=None, iterations=1000, tol=1e-5, verbose=False):
    ...
    :param kmin: positive integer containing
        the minimum number of clusters to check for (inclusive)
    :param kmax: positive integer containing
        the maximum number of clusters to check for (inclusive)
    :param iterations: positive integer containing
        the maximum number of iterations for the EM algorithm
    :param tol: non-negative float containing
        the tolerance for the EM algorithm
    :param verbose: boolean that determines if
        the EM algorithm should print information to the standard output
